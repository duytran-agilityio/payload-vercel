...
export const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({ disabled, endpointSlug }) => {
  ...
  return (
    <div style={{ marginTop: '1rem' }}>
      ...
      >
        {/* Google Icon SVG */}
        <svg style={{ marginRight: '8px', width: '18px', height: '18px' }} viewBox="0 0 24 24">
